...
export function guildsRoute(app: FastifyInstance, client: Client) {
        ...
        try {
            ...
            if (!discordRes.ok) {
                ...
                return res
                    ...
                    .send({ error: "Discord authentication failed or token expired" });
            }
            ...
            return res
                ...
                .send({ error: "Failed to fetch servers" });
        }
    });
}